...
public class Info extends BanCommands {
    ...
    public void onCommand(Player p, String[] args) {
        if (!p.hasPermission("mcban.use")) {
            ...
            PluginDescriptionFile pdf = McBan.getPlugin().getDescription();
            ...
            p.sendMessage(ChatColor.GOLD + "Jenkins: " + ChatColor.YELLOW + "https://jenkins.shadow5353.com/job/McBan/");
            p.sendMessage(ChatColor.GOLD + "---------------------------------------------");
        }
    }

    public Info() {
        super("Show information about the McBan", "info", "i");
    }
}
